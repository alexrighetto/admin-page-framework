    ...
    public function setUp() {
		...
		$this->addSettingFields(
			...
			array(	// Sortable text fields
				'strFieldID' => 'text_sortable',
				'strSectionID' => 'text_fields',
				'strTitle' => __( 'Sortable Text Fields', 'admin-page-framework-demo' ),
				'strDescription' => __( 'Drag and drop fields to change the order', 'admin-page-framework-demo' ),
				'strType' => 'text',
				// 'vReadOnly' => true,
				'vDelimiter' => '',
				'fSortable' => true,
				'vDefault' => array( 'one', 'two', 'three', ),
			),		
			array(	// Sortable text fields
				'strFieldID' => 'text_sortable_repeatable',
				'strSectionID' => 'text_fields',
				'strTitle' => __( 'Sortable & Repeatable Text Fields', 'admin-page-framework-demo' ),
				'strType' => 'text',
				// 'vReadOnly' => true,
				'fRepeatable' => true,
				'vDelimiter' => '',
